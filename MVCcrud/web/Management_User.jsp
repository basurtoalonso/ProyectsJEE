...
<html>
    <head><title>Actualizar Usuario</title>
    ...
    <body bgcolor="FAFAFA">
        ...
        <div id="containerr"> 
            ...
            <div id="about">
                <!--<div align="center"><h4><font color="#000000">GESTIONAR USUARIO</font></h4></div>-->

                <%@include file="resources/form/mostrarClientes.jsp" %>
            ...
            <table id="linkList" width="193" class="" height="200" border="0">
                <td width="181">	    
                    ...
                    <ul id="div">	
                        ...
                        <!--<li><a href="agregarpeliculas.php">Registrar Productos</a></li>
