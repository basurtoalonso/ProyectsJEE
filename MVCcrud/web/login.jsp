...
<tr>
 <tr>
     <td height="26" align='center'><input name="entra" type="submit" class="acept" id="jalert" value="ENTRAR"><td>
<input type="reset" value="LIMPIAR" class="cansel">
		

<tr>
<td colspan="2"><a href="registro.jsp?&keepThis=true&TB_iframe=true&height=340&width=350"title="Registro De Usuario"class="thickbox"> <center><span class="Estilo5"><font class=\"content\">Identificarse</font></span></center></a></td>
 </tr>
