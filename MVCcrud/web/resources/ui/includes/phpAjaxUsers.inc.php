...
$statusTipoOK = array("Activo" => "btn-success", "Suspendido" => "btn-warning");
...
if($errorDbConexion == false){
	...
	if(isset($_POST) && !empty($_POST)){
		...
		switch ($_POST['accion']) {
			case 'addUser':
				// Armamos el query
			$query = sprintf("INSERT INTO tbl_usuarios SET usr_nombre='%s', usr_puesto='%s', usr_nick='%s', usr_status='%s'",
				...
				if($resultadoQuery == true){
					...
					$contenidoOK = '
						<tr>
							...
							<td class="centerTXT">
                                                        <a data-accion="editar" class="btn btn-mini" href="'.$id_userOK.'">Editar</a>
                                                        <a data-accion="eliminar" class="btn btn-mini" href="'.$id_userOK.'">Eliminar</a></td>
						<tr>
					';
